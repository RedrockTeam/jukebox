	...
	<section id='container'>
		<section class="content" id='chooseSong'>
			...
			<article class='notice'>
				...
				<p class='article-time'>@datetime($announcement['updated_at'])</p>
				<p class='notice-content'>{{ $announcement['announcement'] }}</p>
			</article>
			@if(!empty($songs))
		...
		<section class="content" id='songList'>
			...
			<a href="{{ URL::route('albums', ['album_id' => $album['album_id']]) }}">
				<div class="song-lister">
					<img class="song-img" src='http://enroll.lot.cat{{ $album['album_cover'] }}' />
					<div class="song-inf">
						<h2 class="song-title">
							{{ $album['album_name'] }}
						</h2>
